...
import { X, ChevronLeft, ChevronRight, Maximize2, Minimize2, Camera, MessageSquare, Heart, Star, Phone, Video } from 'lucide-react';
import { Profile } from '../types';
import { likeProfile, superLikeProfile } from '../services/mockDataService';
