...
import { User, MapPin, Heart, Book, Camera, Edit2, Star, Award } from 'lucide-react';
      ...
      <div className="mt-6">
        ...
        <div className="bg-gray-200 rounded-full h-4 w-full">
          <div
            ...
            style={{ width: `${profile.hotnessScore}%` }}
          ></div>
        </div>
        <p className="text-sm text-gray-600 mt-1">{profile.hotnessScore}/100</p>
      </div>
      <div className="mt-6">
        <h4 className="font-semibold mb-2">Badges</h4>
        <div className="flex flex-wrap gap-2">
          {profile.badges.map((badge, index) => (
            <span key={index} className="bg-yellow-100 text-yellow-800 text-sm font-medium px-2.5 py-0.5 rounded flex items-center">
